...
const translations = {
  hu: {
    ...
    longSleepReminder: '„Még alszik?” jelzés', longSleepReminderHint: '12 óránál hosszabb aktív alvásnál jelez. Soha nem zárja le automatikusan.', startedEarlier: 'Korábban aludt el:', customTime: 'Egyedi idő', stillSleepingQuestion: 'Még alszik?', longSleepReminderText: 'Ez az alvás több mint 12 órája tart. Ellenőrizd, hogy még fut-e.', checkSleepData: 'Ellenőrizd az alvásadatot', overlapWarning: 'Két alvás időben átfedi egymást.', extremeDurationWarning: 'Szokatlanul hosszú alvást találtam.',
