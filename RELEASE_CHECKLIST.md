...
**Adminátadás aktuális megállója — [GPT-6 Astra · high]:** Chrome ismét Opo-tag, Edge admin; mindkettő 1799 alvást mutat. Az utódválasztó két azonos nevű fiókot nem különböztetett meg. Helyi javításként a név alá kiírjuk az email-címet; typecheck, 34/34 account-route teszt és internal build sikeres. Commit/push és új staging Pages-build után email alapján folytatandó az átadás. A staging UI-elfogadás és maga az adminátadás még nyitott.

**Elsőbbség 2026-09-25-én — [GPT-6 Sol · medium]:** az A03 online-pending importtiltás kézi próbája a tesztalvás feltöltésével és törlésével együtt lezárult; Edge és Chrome ismét Boti/1799-et mutatott. A feleség saját eszközén az Opo-kapcsolat és friss szinkron megerősített. Az A04 Free utolsó admin külön tesztcsaládjának megszüntetése és a régi meghívó elutasítása is sikeres. Következő a külön adminátadási próba, majd az A04–A06, A13–A16 maradék kétböngészős/telefonos elfogadása,
