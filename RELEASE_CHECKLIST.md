...
- [ ] **[GPT-6 Astra · high]** A04 — Valódi account-szintű családi kilépés, pending adatok védelme. Implementáció, regresszió és `3114711` commit/push kész: külön eszközleválasztás/újracsatlakozás, account-kilépés, választható vagy automatikus adminátadás, utolsó tag blokkolása, régi device-tokenek visszavonása és utolsó fizető utáni pause. Staging kétaccountos elfogadás hiányzik.
    - [ ] **[GPT-6 Astra · high]** Az utolsó tag külön családmegszüntetési folyamata `badb0a9` commitban felkerült stagingre: friss szerveres export, név- és revízióellenőrzés, atomi végrehajtás, helyi napló/fiók/előfizetés megőrzése, régi kapcsolatok lezárása. Elkülönített staging elfogadás még szükséges; a 2026-09-24-i `ACCOUNT_DEVICE_ALREADY_LINKED` javítás helyben kész, új commit/deploy kell a folytatáshoz. [Checkpoint és tesztlépések](FAMILY_DISSOLUTION_CHECKPOINT_2026-09-23.md). A fióktörlés recovery és backup-retention követelményeit ez nem zárja le.
...
**Elsőbbség 2026-09-23-án:** az A04/A17 családmegszüntetési visszaút elkészítése,
majd kis, elkülönített staging családon az A03 tényleges törlési és visszaállítási
próbája. Ezután az A04–A06, A13–A16 maradék kétböngészős/telefonos elfogadása,
