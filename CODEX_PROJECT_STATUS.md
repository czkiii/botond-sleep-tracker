...
**Aktuális HEAD:** `242770e` a `feat/child-profile-v4` ágon. A staging Worker pontos SHA-ja és az arra futtatott helyi auth-boundary smoke sikeresen ellenőrizve. Az A24 PWA-frissítési és offline fiókindítási javítások helyben elkészültek, még nincsenek commitolva; 338/338 teszt és két alapútvonalas böngészős életcikluspróba sikeres. Opo/Boti/1799 és a családi szerepek nem változtak. A családmegszüntetés korábbi javításának kézi visszatesztje továbbra is nyitott. Részletek: [PWA_UPDATE_CHECKPOINT_2026-09-26.md](PWA_UPDATE_CHECKPOINT_2026-09-26.md), [FAMILY_DISSOLUTION_CHECKPOINT_2026-09-23.md](FAMILY_DISSOLUTION_CHECKPOINT_2026-09-23.md).
