...
**Aktuális HEAD:** `88a1654` a `feat/child-profile-v4` ágon. Az emailes adminutód-választó és az oda-vissza adminátadás stagingen elfogadva; Edge admin, Chrome tag, mindkettő Opo/Boti/1799 és friss szinkron. A családmegszüntetés utáni téves hibaválasz helyben javítva; 296/296 teszt és Worker typecheck sikeres; a javítás commit/push megtörtént, staging Worker-verzió és kézi elfogadás még ellenőrizendő. Részletek: [FAMILY_DISSOLUTION_CHECKPOINT_2026-09-23.md](FAMILY_DISSOLUTION_CHECKPOINT_2026-09-23.md).
